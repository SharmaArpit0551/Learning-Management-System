...
const CourseDetail = () => {
    ...
    const { data, isLoading, isError } = useGetCourseDetailWithPurchaseQuery(courseId);
    ...
    const summarizeDescriptionHandler = async() => {
        // Pass the `courseId` to the mutation action.
        ...
        <div className="space-y-5 mt-20">
            ...
            <div className="max-w-7xl mx-auto my-5 px-4 md:px-8 flex flex-col lg:flex-row justify-between gap-10">
                ...
                <div className="w-full lg:w-1/3">
                    ...
                    <Button className="w-full mt-6" disabled={summarizedLoading} onClick={summarizeDescriptionHandler}>
                        Summarize Detail
                    </Button>
